    ...
    _public_metrics.add_group(
      prometheus_sanitize::metrics_name("relay"),
      {
        ...
        sm::make_histogram(
          ...
          [this] { return _fanout_duration.public_histogram_logform(); })
          .aggregate({ss::metrics::shard_label}),
        sm::make_histogram(
          ...
          [this] { return _crossshard_dispatch.public_histogram_logform(); })
          .aggregate({ss::metrics::shard_label}),
        sm::make_histogram(
          ...
          [this] { return _consume_delay.public_histogram_logform(); })
          .aggregate({ss::metrics::shard_label}),
      });
}
